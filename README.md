...
│                    🌐 Presentation Layer                    
├─────────────────────────────────────────────────────────────
│  HTTP Server  │  gRPC Server  │  MQTT Client  │  Webhooks  
├─────────────────────────────────────────────────────────────
│                    🏢 Business Logic Layer                  
├─────────────────────────────────────────────────────────────
│  Services     │  Use Cases    │  Validators   │  Auth      
├─────────────────────────────────────────────────────────────
│                    💾 Data Access Layer                     
├─────────────────────────────────────────────────────────────
│  Repositories │  Database     │  Migrations   │  Seeds      
└─────────────────────────────────────────────────────────────
```
...
| Layer | Description |
|-------|--------------|
| 🌐 **Presentation Layer** | Обеспечивает взаимодействие с внешним миром: REST/gRPC API, MQTT и Webhooks. |
| 🏢 **Business Logic Layer** | Содержит основную бизнес-логику приложения: сервисы, use cases, правила и валидацию. |
| 💾 **Data Access Layer** | Отвечает за работу с данными — репозитории, базы данных, миграции и seeds. |
