...
const OperationPruebav1ServiceDeletePruebaById = "/api.prueba.v1.Pruebav1Service/DeletePruebaById"
...
type Pruebav1ServiceHTTPServer interface {
	// DeletePruebaById DELETE /v1/prueba?id=123 - delete by id
...
func RegisterPruebav1ServiceHTTPServer(s *http.Server, srv Pruebav1ServiceHTTPServer) {
	...
	r.DELETE("/v1/prueba", _Pruebav1Service_DeletePruebaById0_HTTP_Handler(srv))
}
...
func _Pruebav1Service_DeletePruebaById0_HTTP_Handler(srv Pruebav1ServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in DeletePruebaByIdRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationPruebav1ServiceDeletePruebaById)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
// DeletePruebaById DELETE /v1/prueba?id=123 - delete by id
func (c *Pruebav1ServiceHTTPClientImpl) DeletePruebaById(ctx context.Context, in *DeletePruebaByIdRequest, opts ...http.CallOption) (*DeletePruebaByIdResponse, error) {
	var out DeletePruebaByIdResponse
	pattern := "/v1/prueba"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationPruebav1ServiceDeletePruebaById))
